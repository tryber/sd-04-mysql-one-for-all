...
INSERT INTO
  usuarios (nome_usuario, idade, plano_id)
VALUES
  ('Thati', 23, 1),
  ('Cintia', 35, 2),
  ('Bill', 20, 3),
...
INSERT INTO
  albuns (titulo_album, artista_id)
VALUES
  ('Envious', 1),
  ('Exuberant', 1),
  ('Hallowed Steam', 2),
...
INSERT INTO
  cancoes (titulo_cancao, album_id, artista_id)
VALUES
  ('Soul For Us', 1, 1),
...
INSERT INTO
  historico_reproducoes (usuario_id, cancao_id)
VALUES
  (1, 1),
  (1, 6),
  (1, 14),
