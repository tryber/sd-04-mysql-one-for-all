...
CREATE TABLE cancoes (
    ...
    titulo_cancoes VARCHAR(100) NOT NULL,
    album_id INT NOT NULL,
    FOREIGN KEY (album_id)
        REFERENCES albuns (album_id)
)  ENGINE=INNODB;

INSERT INTO cancoes (titulo_cancoes, album_id)
VALUES 
('Soul For Us',1),
('Magic Circus',3),
('Diamond Power',4),
...
CREATE TABLE historico_reproduçoes (
...
INSERT INTO historico_reproduçoes (cancao_id, usuario_id)
VALUES 
(1, 1),
(2, 1),
(3, 1),
